...
def createTestEnvironment(self):
    ...
    self.shop.shippingprices.manage_addProduct["iqpp.easyshop"].addShippingPrice(id="default", price=10.0)
    self.shop.shippingprices.default.reindexObject()
    
    self.shop.paymentprices.manage_addProduct["iqpp.easyshop"].addPaymentPrice(id="default", price=100.0)
    
    self.shop.setCountries(["Germany"])
    self.shop.products.manage_addProduct["iqpp.easyshop"].addProduct(id="product_1", price=22.0)
    ...
    self.shop.products.manage_addProduct["iqpp.easyshop"].addProduct(id="product_2", price=19.0)
    ...
    self.shop.products.manage_addProduct["iqpp.easyshop"].addProduct(id="product_42", price=19.0)
    ...
    # Categories
    self.shop.manage_addProduct["iqpp.easyshop"].addCategory(id="category_1")
    self.shop.category_1.manage_addProduct["iqpp.easyshop"].addCategory(id="category_11")
    self.shop.category_1.manage_addProduct["iqpp.easyshop"].addCategory(id="category_12")
    self.shop.category_1.category_11.manage_addProduct["iqpp.easyshop"].addCategory(id="category_111")
    self.shop.manage_addProduct["iqpp.easyshop"].addCategory(id="category_2")
    self.shop.manage_addProduct["iqpp.easyshop"].addCategory(id="category_3")
    ...
    # taxes    
    self.shop.taxes.manage_addProduct["iqpp.easyshop"].addDefaultTax(id="default", rate=19.0)
