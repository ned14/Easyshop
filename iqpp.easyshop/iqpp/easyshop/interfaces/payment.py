...
from iqpp.easyshop.config import CREDIT_CARDS_CHOICES
from iqpp.easyshop.config import CREDIT_CARD_MONTHS_CHOICES
from iqpp.easyshop.config import CREDIT_CARD_YEARS_CHOICES
