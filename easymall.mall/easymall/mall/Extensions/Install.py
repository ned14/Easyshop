# NOTE: This is completely taken from Martin Aspeli's (optilude) RichtDocument
# and works like a charm. Thanks Martin!
...
EXTENSION_PROFILES = (
    "easymall.catalog:default",
    "easymall.mall:default",    
    "easymall.shop:default",
)
