...
METATYPES_NOT_TO_LIST = ["EasyShopPhoto", 
                         "EasyShopProduct", 
                         "EasyShopProducts",                          
                         "EasyShopCategory",
                         "EasyShopCustomer",
                         ...
                         "CustomerTax",
                         "DefaultTax",
                         "EasyShopShippingPrice",
                         "EasyShopCategoryCriteria",
                         "EasyShopCountryCriteria",
                         "EasyShopCustomerCriteria",                         
                         "EasyShopDateCriteria",
                         "EasyShopGroupCriteria",
                         "EasyShopProductCriteria",
                         "EasyShopOrder",
                         "EasyShopOrderItem",
                         "EasyShopDirectDebit",
                         "EasyShopPayPal",                                                                                                                                                                                                                                                          
